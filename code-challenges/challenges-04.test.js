...
expression pattern to return true if the string contains the letter 'w' in lower case or false if it does not. 
...
a regular expression pattern to return a new array containing any cities that begin with the 
